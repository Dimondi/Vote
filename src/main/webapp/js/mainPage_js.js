$(document).ready(function() {
    ...
    function displayEvents2(resultData){
        $.each(resultData, function (i, obj) {
            $("#popular").append('<a class="btn btn-primary" href="/poll/'+ obj.id +'" role="button">' + obj.pollTitle+ '</a>\n');
        })
    }
    ...
    function displayEvents3(resultData){
        $.each(resultData, function (i, obj) {
            $("#latest").append('<a class="btn btn-primary" href="/poll/'+ obj.id +'" role="button">' + obj.pollTitle+ '</a>\n');
        })
    }
